...
public abstract class CrudTest<KEY extends Serializable, EN extends Persistent<KEY>> extends JUnitTest 
{
     ...
     *
     * @return a valid non-persistent instance of {@link br.com.trustsystems.persistence.Persistent}
     */
     ...
     *
     * @return an instance of the DAO that manages the {@link br.com.trustsystems.persistence.Persistent} of the tests
     */
    ...
    public void tearDown() 
    {
        ...
        if (difference != 0)
            logger.error("Test method did not leave database in its initial state! Difference is: " + difference);
    }
